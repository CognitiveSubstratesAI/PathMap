-- Adapted from Adam Vandervorst/PathMap lean/PathMapModel/PathMap.lean @ f477a91 (MIT, see ../LICENSE-UPSTREAM).
-- Namespace renamed PathMapModel -> PathMapsSpec; specifies the INTENDED behaviour of our Julia PathMaps.
